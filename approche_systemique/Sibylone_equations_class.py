...
class SibyloneModel:
    ...
    def run_simulation(self, t):
        initial_conditions = [self.S_0, self.M_0, self.AK_0, self.K_0, self.R1_0, self.R2_0,
                              self.P_0, self.C_0, self.INTER_CONTRAT_0, self.MISSION_0, 0, 0, 0, 0]
        result = odeint(self.sibylone_process, initial_conditions, t)
        return result